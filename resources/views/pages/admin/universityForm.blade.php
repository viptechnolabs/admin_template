    ...
    <div>
        <div class="container content-wrapper">
            ...
            <div class="card card-default">
                ...
                <form action="{{ route('admin.addUniversity') }}" method="POST" name="addUniversity" id="addUniversity">
                @csrf
                <!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
...
@push('scripts')
    ...
    <script>
        $('#addUniversity').validate({
            ...
            messages: {
                name: {
                    required: "University Name Must be Required.",
                },
                code: {
                    required: "University Code Must be Required.",
                },
                contact: {
