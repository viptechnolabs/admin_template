    ...
    <div>
        <div class="container content-wrapper">
            <div class="card card-default">
                ...
                <form action="{{ route('admin.addCollage') }}" method="POST" name="addCollage" id="addCollage">
                @csrf
                <!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="address"
                                              placeholder="Collage Address *"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
...
@push('scripts')
    ...
    <script>
        $('#addCollage').validate({
            ...
            messages: {
                name: {
                    required: "Collage Name Must be Required.",
                },
                code: {
                    required: "Collage Code Must be Required.",
                },
                contact: {
